...
def parse_experiment_args(description="Drone group experiment"):
    ...
    - --rekey-scheme: esquema de rekey (naive|lkh).
    - --num-drones: tamanho do grupo N.
    - --fast / --wait-scale: encurta os waits para campanhas grandes.
    """
...
def collect_incontainer_csvs(
    ...
    e grava em:
        <output_dir>/run-<run_id>/<node.name>-<arquivo>
